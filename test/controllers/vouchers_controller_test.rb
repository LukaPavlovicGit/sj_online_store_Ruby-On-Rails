...
class VouchersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voucher" do
    assert_difference("Voucher.count") do
      post vouchers_url, params: { voucher: { comment: @voucher.comment, user_id: @voucher.user_id, value: @voucher.value } }
    end
  ...
  test "should update voucher" do
    patch voucher_url(@voucher), params: { voucher: { comment: @voucher.comment, user_id: @voucher.user_id, value: @voucher.value } }
